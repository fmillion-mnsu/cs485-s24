# CS 485 – Topics in Platform-Based Development - Syllabus
...
- **Semester/Block**: Spring 2024, Block 2 (3/11/2024 through 5/3/2024), **14** class sessions
- **Days and Time**: Tuesdays and Thursdays, 4:00 PM - 5:50 PM ([iCalendar File](https://github.com/fmillion-mnsu/cs485-s24/raw/master/cs485.ics))
...
This course will build upon basic DevOps concepts and explore advanced software packaging, deployment, maintenance and lifecycle management. We will explore advanced CI/CD concepts, delve deeper into containerization and automated deployment strategies, and explore topics in distributed systems and load balancing. If you've ever wondered "how does Google *just work* for millions of users at the same time", you'll have an answer by the end of this course (and will have even tested it out yourself!*)

As part of this course, you will get some experience with working with command line interfaces, in particular the Linux command line. If you are on a Windows PC, you can use Windows Subsystem for Linux to run a Linux virtual machine with minimal effort - we will cover this in class. Mac users should be able to use the built in Terminal application.

<small>* Not on 100 million users, of course!</small>
...
**I will be away at an academic conference during the week of March 18th, 2024.** During that week we will *not* have lectures, but you will be assigned a significant group project. I expect you to use the usual class time to meet with your group and work on the project. You may use the classroom or you may meet elsewhere.

**We will NOT meet during Finals Week (the week of April 29th).** You will have the final week to complete your last group and individual projects.
